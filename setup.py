...
if os.path.exists("requirements.txt"):
    ...
    requirements = [
        ...
        "gdown>=4.4.0",
        "xformers>=0.0.18",
        "ptutils @ git+ssh://git@github.com/anayebi/ptutils.git@a0512026013725522ec7af2a68e72e3e28de5325",
        "brainmodel_utils @ git+ssh://git@github.com/anayebi/brainmodel_utils.git@231ebf2de33b3a6a6a279be540278fb7c892d99a",
